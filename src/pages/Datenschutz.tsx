...
const Datenschutz = () => {
    return (
        <section id="datenschutz" className="section-padding">
            <div className="container-section">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p>Das externe Hosting erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen und bestehenden
                        ...
                        unseres Online-Angebots durch einen professionellen Anbieter (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende
                    ...
                    <p>Beacons AI INC.<br />
                        2261 Market St Pmb 4319 San Francisco, CA 94114-1612, United States</p>
                    ...
                    <p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes geschlossen.
                        ...
                        verarbeitet.</p>
                    <p>Datenübermittlung in die USA Da unser Hoster Beacons AI INC. seinen Sitz in den Vereinigten Staaten von Amerika (USA)
                        hat, erfolgt eine Übermittlung Ihrer personenbezogenen Daten in ein Drittland außerhalb der Europäischen Union bzw.
                        des Europäischen Wirtschaftsraums. Die USA gelten nach aktueller Rechtsprechung des Europäischen Gerichtshofs als
                        Land mit einem im Vergleich zur EU nicht sicheren Datenschutzniveau.

                        Wir stützen die Datenübermittlung in die USA auf die Standardvertragsklauseln (SCCs) der EU-Kommission, die wir mit
                        unserem Hoster vereinbart haben. Zusätzlich haben wir ergänzende Maßnahmen (technisch und organisatorisch)
                        getroffen, um das Risiko des Zugriffs durch US-Behörden zu minimieren, soweit dies möglich und erforderlich ist. Die
                        Rechtsgrundlage für diesen Transfer ist somit Art. 46 Abs. 2 lit. c DSGVO (Standardvertragsklauseln) in Verbindung
                        mit Art. 49 Abs. 1 lit. a DSGVO (Ihre explizite Einwilligung im Consent-Management-System).</p>
                    ...
                    <p>Clarissa Heinemann<br />
                        Ampfingstra&szlig;e 44<br />
                        81671 M&uuml;nchen</p>

                    <p>Telefon: +4915222389418<br />
                        E-Mail: a.tech.glitch@gmail.com</p>
                    ...
                    <p>Auf dieser Website werden Elemente von sozialen Medien verwendet (z.&nbsp;B. Facebook, X, Instagram, Pinterest, XING,
                        LinkedIn, Tumblr).</p>
                    <p>Die Social-Media-Elemente k&ouml;nnen Sie in der Regel anhand der jeweiligen Social-Media-Logos erkennen. Um den
                        Datenschutz auf dieser Website zu gew&auml;hrleisten, verwenden wir diese Elemente nur zusammen mit der sogenannten
                        &bdquo;Shariff&ldquo;-L&ouml;sung. Diese Anwendung verhindert, dass die auf dieser Website integrierten
                        Social-Media-Elemente Ihre personenbezogenen Daten schon beim ersten Betreten der Seite an den jeweiligen Anbieter
                        &uuml;bertragen.</p>
                    <p>Erst wenn Sie das jeweilige Social-Media-Element durch Anklicken der zugeh&ouml;rigen Schaltfl&auml;che aktivieren,
                        ...
                        Social-Media-Element aktivieren, erh&auml;lt der jeweilige Anbieter die Information, dass Sie mit Ihrer IP-Adresse
                        diese Website besucht haben. Wenn Sie gleichzeitig in Ihrem jeweiligen Social-Media-Account (z.&nbsp;B. Facebook)
                        eingeloggt sind, kann der jeweilige Anbieter den Besuch dieser Website Ihrem Benutzerkonto zuordnen.</p>
                    <p>Das Aktivieren des Plugins stellt eine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1
                        TDDDG dar. Diese Einwilligung k&ouml;nnen Sie jederzeit mit Wirkung f&uuml;r die Zukunft widerrufen.</p>
                    <p>Der Einsatz des Dienstes erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen f&uuml;r den Einsatz bestimmter
                        Technologien einzuholen. Rechtsgrundlage hierf&uuml;r ist Art. 6 Abs. 1 lit. c DSGVO.</p>
                    <h3>Instagram</h3>
                    <p>Auf dieser Website sind Funktionen des Dienstes Instagram eingebunden. Diese Funktionen werden angeboten durch die
                        Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland.</p>
                    <p>Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endger&auml;t und dem
                        Instagram-Server hergestellt. Instagram erh&auml;lt dadurch Informationen &uuml;ber den Besuch dieser Website durch
                        Sie.</p>
                    <p>Wenn Sie in Ihrem Instagram-Account eingeloggt sind, k&ouml;nnen Sie durch Anklicken des Instagram-Buttons die
                        Inhalte dieser Website mit Ihrem Instagram-Profil verlinken. Dadurch kann Instagram den Besuch dieser Website Ihrem
                        Benutzerkonto zuordnen. Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der
                        &uuml;bermittelten Daten sowie deren Nutzung durch Instagram erhalten.</p>
                    <p>Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO und &sect; 25
                        Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>
                    <p>Soweit mit Hilfe des hier beschriebenen Tools personenbezogene Daten auf unserer Website erfasst und an Facebook bzw.
                        Instagram weitergeleitet werden, sind wir und die Meta Platforms Ireland Limited, 4 Grand Canal Square, Grand Canal
                        Harbour, Dublin 2, Irland gemeinsam f&uuml;r diese Datenverarbeitung verantwortlich (Art. 26 DSGVO). Die gemeinsame
                        Verantwortlichkeit beschr&auml;nkt sich dabei ausschlie&szlig;lich auf die Erfassung der Daten und deren Weitergabe
                        an Facebook bzw. Instagram. Die nach der Weiterleitung erfolgende Verarbeitung durch Facebook bzw. Instagram ist
                        nicht Teil der gemeinsamen Verantwortung. Die uns gemeinsam obliegenden Verpflichtungen wurden in einer Vereinbarung
                        &uuml;ber gemeinsame Verarbeitung festgehalten. Den Wortlaut der Vereinbarung finden Sie unter: <a
                            ...
                            rel="noopener noreferrer">https://www.facebook.com/legal/controller_addendum</a>. Laut dieser Vereinbarung sind
                        wir f&uuml;r die Erteilung der Datenschutzinformationen beim Einsatz des Facebook- bzw. Instagram-Tools und f&uuml;r
                        die datenschutzrechtlich sichere Implementierung des Tools auf unserer Website verantwortlich. F&uuml;r die
                        Datensicherheit der Facebook bzw. Instagram-Produkte ist Facebook verantwortlich. Betroffenenrechte (z.&nbsp;B.
                        Auskunftsersuchen) hinsichtlich der bei Facebook bzw. Instagram verarbeiteten Daten k&ouml;nnen Sie direkt bei
                    ...
                    <p>Die Daten&uuml;bertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gest&uuml;tzt. Details
                    ...
                    <p>Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US Data Privacy Framework&ldquo; (DPF).
                        ...
                        europ&auml;ischer Datenschutzstandards bei Datenverarbeitungen in den USA gew&auml;hrleisten soll. Jedes nach dem
                        DPF zertifizierte Unternehmen verpflichtet sich, diese Datenschutzstandards einzuhalten. Weitere Informationen
                        hierzu erhalten Sie vom Anbieter unter folgendem Link: <a
                            href="https://www.dataprivacyframework.gov/participant/4452" target="_blank"
                    ...
                    <p>Die Verarbeitung der in das Newsletteranmeldeformular eingegebenen Daten erfolgt ausschlie&szlig;lich auf Grundlage
                        Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Die erteilte Einwilligung zur Speicherung der Daten, der
                        E-Mail-Adresse sowie deren Nutzung zum Versand des Newsletters k&ouml;nnen Sie jederzeit widerrufen, etwa &uuml;ber
                        den &bdquo;Austragen&ldquo;-Link im Newsletter. Die Rechtm&auml;&szlig;igkeit der bereits erfolgten
                    ...
                    <p>Die von Ihnen zum Zwecke des Newsletter-Bezugs bei uns hinterlegten Daten werden von uns bis zu Ihrer Austragung aus
                        dem Newsletter bei uns bzw. dem Newsletterdiensteanbieter gespeichert und nach der Abbestellung des Newsletters oder
                        nach Zweckfortfall aus der Newsletterverteilerliste gel&ouml;scht. Wir behalten uns vor, E-Mail-Adressen aus unserem
                        Newsletterverteiler nach eigenem Ermessen im Rahmen unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO
                        zu l&ouml;schen oder zu sperren.</p>
                    ...
                    <p>Nach Ihrer Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei uns bzw. dem
                        Newsletterdiensteanbieter ggf. in einer Blacklist gespeichert, sofern dies zur Verhinderung k&uuml;nftiger Mailings
                        erforderlich ist. Die Daten aus der Blacklist werden nur f&uuml;r diesen Zweck verwendet und nicht mit anderen Daten
                        zusammengef&uuml;hrt. Dies dient sowohl Ihrem Interesse als auch unserem Interesse an der Einhaltung der
                        gesetzlichen Vorgaben beim Versand von Newslettern (berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f DSGVO).
                        Die Speicherung in der Blacklist ist zeitlich nicht befristet. <strong>Sie k&ouml;nnen der Speicherung
                            widersprechen, sofern Ihre Interessen unser berechtigtes Interesse &uuml;berwiegen.</strong></p>
                    <h4>Einsatz von CleverReach </h4>
                    <p>Der Versand der Newsletter erfolgt mittels des Versanddienstleisters CleverReach (CleverReach
                        GmbH & Co. KG, Mühlenstr. 43, 26180 Rastede, Deutschland).
                        CleverReach ist ein Dienst, mit dem der Newsletterversand organisiert und analysiert werden kann. Die von Ihnen zum
                        Zwecke des Newsletterbezugs eingegebenen Daten (z. B. E-Mail-Adresse) werden auf den Servern von CleverReach in
                        Deutschland bzw. Europa gespeichert.
                        Datenanalyse durch CleverReach Die mit CleverReach versandten E-Mails enthalten sogenannte Web-Beacons (Zählpixel).
                        Hierdurch kann CleverReach feststellen, ob eine Newsletter-Nachricht geöffnet wurde und welche Links im Newsletter
                        angeklickt wurden. Außerdem werden technische Informationen (z. B. Zeitpunkt des Abrufs, IP-Adresse, Browsertyp und
                        Betriebssystem) erfasst. Diese Informationen dienen ausschließlich der statistischen Analyse der
                        Newsletter-Kampagnen. Die Analyse erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
                        Wir haben mit CleverReach einen Vertrag zur Auftragsverarbeitung (AVV) abgeschlossen.
                        Weitere Informationen zum Datenschutz von CleverReach finden Sie hier: https://www.cleverreach.com/de/datenschutz/
                    </p>
                    <h2>7. eCommerce und Zahlungsabwicklung</h2>

                    <h3>Datenverarbeitung zu Vertragszwecken</h3>
                    Zur Abwicklung des Kaufvertrages, den Sie über unseren Online-Shop abschließen, verarbeiten wir personenbezogene Daten
                    unserer Kunden (Vertragsdaten). Dies umfasst insbesondere die Erfassung von Bestellungen, den Versand der digitalen
                    Produkte, die Abwicklung von Zahlungen, die Geltendmachung etwaiger Gewährleistungsansprüche und die Klärung von
                    Rückfragen.
                    <ul>
                        <li>Betroffene Daten: Name, Anschrift, E-Mail-Adresse, Telefonnummer, Kaufhistorie, Zahlungsdaten, Bestelldaten.
                        </li>
                        <li>Zweck: Vertragsabwicklung, Kundenservice und Betrugsprävention.</li>
                        <li>Rechtsgrundlage: Erfüllung eines Vertrages oder Durchführung vorvertraglicher Maßnahmen (Art. 6 Abs. 1 lit. b
                            DSGVO).</li>
                        <li>Speicherdauer: Wir speichern diese Daten, bis der Zweck der Datenspeicherung entfällt, wobei handels- und
                            steuerrechtliche Aufbewahrungsfristen (6 bzw. 10 Jahre) hiervon unberührt bleiben.</li>
                    </ul>

                    <h3>Übermittlung von Daten an Beacons.ai (Verkaufsplattform)</h3>
                    Für den Betrieb des Online-Shops (Produktanzeige, Kaufabwicklung, digitale Auslieferung) nutzen wir die Plattform
                    Beacons.ai. Die bei der Bestellung von Ihnen eingegebenen Daten werden an Beacons AI INC. übermittelt.
                    <ul>
                        <li>Dienstleister: Beacons AI INC., 2261 Market St Pmb 4319 San Francisco, CA 94114-1612, United States.</li>
                        <li>Zweck: Bereitstellung der Shop-Funktionalität und Abwicklung der Transaktion.</li>
                        <li>Rechtsgrundlage: Vertragserfüllung (Art. 6 Abs. 1 lit. b DSGVO).</li>
                        <li>Hinweis zum Drittlandtransfer: Es gelten die oben unter 2. Hosting genannten Bestimmungen zur Datenübermittlung
                            in die
                            USA.</li>
                    </ul>

                    <h3>Zahlungsanbieter</h3>
                    <p>Wir geben zur Abwicklung von Zahlungen Ihre Zahlungsdaten an spezialisierte Zahlungsdienstleister weiter. Der Einsatz
                        dieser Dienstleister erfolgt zur Erfüllung des Vertrages (Art. 6 Abs. 1 lit. b DSGVO).</p>
                    <h4>PayPal</h4>
                    <p>Wir nutzen den Dienst PayPal. Anbieter ist die PayPal (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449
                        Luxembourg.
                        Die Datenübermittlung an PayPal umfasst in der Regel folgende Daten: Name, E-Mail-Adresse, Anschrift, Telefonnummer,
                        IP-Adresse, Bestellnummer, Rechnungsbetrag, Währung sowie transaktionsbezogene Daten.
                        Die Datenübertragung an PayPal erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO zur Vertragsabwicklung und
                        -erfüllung.
                        Hinweis zum Drittlandtransfer bei PayPal: PayPal kann Daten in die USA übermitteln, da das Mutterunternehmen (PayPal
                        Holdings, Inc.) dort sitzt. Die Übermittlung in die USA ist durch die Zertifizierung von PayPal nach dem EU-US Data
                        Privacy Framework (DPF) abgedeckt, was ein angemessenes Datenschutzniveau gewährleistet.
                        Details finden Sie in der Datenschutzerklärung von PayPal: https://www.paypal.com/de/webapps/mpp/ua/privacy-full</p>
                    <h2>8. Plugins und Tools</h2>
                    <h3>Google reCAPTCHA</h3>
                    <p>Wir nutzen &bdquo;Google reCAPTCHA&ldquo; (im Folgenden &bdquo;reCAPTCHA&ldquo;) auf dieser Website. Anbieter ist die
                        Google Ireland Limited (&bdquo;Google&ldquo;), Gordon House, Barrow Street, Dublin 4, Irland.</p>
                    <p>Mit reCAPTCHA soll &uuml;berpr&uuml;ft werden, ob die Dateneingabe auf dieser Website (z.&nbsp;B. in einem
                        Kontaktformular) durch einen Menschen oder durch ein automatisiertes Programm erfolgt. Hierzu analysiert reCAPTCHA
                        das Verhalten des Websitebesuchers anhand verschiedener Merkmale. Diese Analyse beginnt automatisch, sobald der
                        Websitebesucher die Website betritt. Zur Analyse wertet reCAPTCHA verschiedene Informationen aus (z.&nbsp;B.
                        IP-Adresse, Verweildauer des Websitebesuchers auf der Website oder vom Nutzer get&auml;tigte Mausbewegungen). Die
                        bei der Analyse erfassten Daten werden an Google weitergeleitet.</p>
                    <p>Die reCAPTCHA-Analysen laufen vollst&auml;ndig im Hintergrund. Websitebesucher werden nicht darauf hingewiesen, dass
                        eine Analyse stattfindet.</p>
                    <p>Die Speicherung und Analyse der Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
                        ein berechtigtes Interesse daran, seine Webangebote vor missbr&auml;uchlicher automatisierter Aussp&auml;hung und
                        vor SPAM zu sch&uuml;tzen. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
                        ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die
                        Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B.
                    ...
                    <p>Weitere Informationen zu Google reCAPTCHA entnehmen Sie den Google-Datenschutzbestimmungen und den Google
                        Nutzungsbedingungen unter folgenden Links: <a href="https://policies.google.com/privacy?hl=de" target="_blank"
                    ...
                    <h3>KI-Chatbot „Pia" (Google Gemini / Gemini API – kostenpflichtiger Tier)</h3>
                    <p>Auf dieser Website ist der KI-gestützte Chatbot „Pia" integriert, der auf einem Sprachmodell der Google-Gemini-Familie (Gemini Flash) basiert und über die kostenpflichtige Gemini API (Paid Tier, mit aktiviertem Google Cloud Billing) betrieben wird. Pia ist als KI-System gemäß Art. 50 EU AI Act ausdrücklich als solches gekennzeichnet.</p>

                    <h4>Verarbeitete Daten</h4>
                    <p>Bei jeder Nachricht, die im Chatbot eingegeben wird, werden die Texteingaben sowie der gesamte bisherige Gesprächsverlauf der Sitzung an die Gemini API übermittelt. Dies kann personenbezogene Daten umfassen, die freiwillig eingegeben werden – darunter insbesondere E-Mail-Adressen, Namen oder Projektbeschreibungen. Eingegebene E-Mail-Adressen werden damit an Google übertragen und dort verarbeitet.</p>

                    <h4>Zweck der Verarbeitung</h4>
                    <p>Die Übermittlung der Daten dient der automatisierten Beantwortung von Fragen zu den angebotenen Leistungen, Projekten und Preisen. Eine automatisierte Entscheidungsfindung im Sinne von Art. 22 DSGVO findet nicht statt.</p>

                    <h4>Rechtsgrundlage</h4>
                    <p>Die Verarbeitung der Chat-Inhalte erfolgt auf Grundlage des berechtigten Interesses an der effizienten Beantwortung von Nutzeranfragen (Art. 6 Abs. 1 lit. f DSGVO). Soweit im Chat aktiv personenbezogene Daten eingegeben werden (z.&nbsp;B. eine E-Mail-Adresse), gilt insoweit die freiwillige Einwilligung durch die Eingabe (Art. 6 Abs. 1 lit. a DSGVO).</p>

                    <h4>Datenweiterleitung über n8n und E-Mail</h4>
                    <p>Der Chatbot verfügt über automatisierte Werkzeuge (sog. „Tools"), über die im Gespräch erfasste Daten gespeichert und weitergeleitet werden können. Hierfür wird die selbst gehostete Workflow-Automatisierungsplattform n8n eingesetzt, die auf Servern der Netcup GmbH (Daimlerstraße 25, 76185 Karlsruhe, Deutschland) betrieben wird. Mit Netcup als Hostinganbieter besteht ein Vertrag über Auftragsverarbeitung (AVV). Eine Übermittlung dieser Daten in Drittländer findet im Rahmen von n8n nicht statt.</p>
                    <p>Über n8n können im Chat eingegebene personenbezogene Daten – darunter insbesondere E-Mail-Adressen und Projektbeschreibungen – gespeichert und per E-Mail an die verantwortliche Stelle (Clarissa Heinemann) weitergeleitet werden. Dies geschieht zum Zweck der Bearbeitung eingehender Anfragen. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Bearbeitung von Anfragen) sowie Art. 6 Abs. 1 lit. a DSGVO für aktiv eingegebene personenbezogene Daten.</p>
                    <p>Darüber hinaus werden Fragen, die der Chatbot auf Basis der verfügbaren Informationen nicht beantworten kann, automatisch erfasst und ebenfalls über n8n per E-Mail an die verantwortliche Stelle weitergeleitet. Zweck dieser Verarbeitung ist die Analyse häufiger Kundenanfragen sowie die Weiterentwicklung und Verbesserung des Chatbot-Angebots. Die dabei verarbeiteten Daten umfassen den jeweiligen Fragetext sowie ggf. weitere im Gesprächsverlauf enthaltene personenbezogene Daten. Eine Zusammenführung mit anderen Nutzerdaten oder eine Weitergabe an Dritte findet nicht statt. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Qualitätssicherung und Weiterentwicklung des Dienstes).</p>

                    <h4>Speicherung nicht beantwortbarer Fragen in Google Sheets</h4>
                    <p>Fragen, die der Chatbot nicht beantworten kann, werden zusätzlich zur E-Mail-Weiterleitung in einer Tabelle bei Google Sheets gespeichert. Anbieter ist die Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Zweck dieser Speicherung ist ausschließlich die Auswertung häufiger Anfragen sowie die kontinuierliche Verbesserung der vom Chatbot bereitgestellten Informationen. Die gespeicherten Daten umfassen in der Regel den jeweiligen Fragetext; soweit Nutzer in der Frage selbst personenbezogene Daten angeben, können auch diese erfasst werden. Eine Zusammenführung mit anderen Datenquellen oder eine Weitergabe an Dritte erfolgt nicht.</p>
                    <p>Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Qualitätssicherung und Weiterentwicklung des Dienstes). Die in Google Sheets gespeicherten Einträge werden regelmäßig überprüft und spätestens nach Wegfall des Auswertungszwecks, längstens jedoch nach zwölf Monaten, gelöscht. Mit Google ist für die Nutzung von Google Sheets bzw. Google Workspace ein Vertrag über Auftragsverarbeitung (AVV) abgeschlossen. Da die Infrastruktur von Google auch Server in den USA umfasst, kann es zu einer Übermittlung der Daten in die USA kommen; diese ist durch die Zertifizierung von Google LLC nach dem EU-US Data Privacy Framework (DPF) sowie ergänzend durch Standardvertragsklauseln (Art. 46 Abs. 2 lit. c DSGVO) abgesichert.</p>

                    <h4>Gemini API – Dienstleister und Drittlandübermittlung</h4>
                    <p>Anbieter des KI-Dienstes ist die Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Da die Infrastruktur von Google auch Server in den USA umfasst, kann es zu einer Übermittlung der Daten in die USA kommen. Google LLC (1600 Amphitheatre Parkway, Mountain View, CA 94043, USA) ist nach dem EU-US Data Privacy Framework (DPF) zertifiziert, das ein angemessenes Datenschutzniveau gewährleistet. Die Übermittlung stützt sich auf Art. 45 Abs. 1 DSGVO i.&nbsp;V.&nbsp;m. dem DPF-Angemessenheitsbeschluss der EU-Kommission sowie ergänzend auf Standardvertragsklauseln gemäß Art. 46 Abs. 2 lit. c DSGVO.</p>
                    <p>Weitere Informationen zur DPF-Zertifizierung von Google finden Sie unter: <a href="https://www.dataprivacyframework.gov/participant/5780" target="_blank" rel="noopener noreferrer">https://www.dataprivacyframework.gov/participant/5780</a>.</p>

                    <h4>Nutzung der Daten durch Google</h4>
                    <p>Der Chatbot wird über die kostenpflichtige Gemini API (Paid Tier) mit aktiviertem Google Cloud Billing betrieben. Nach den für den kostenpflichtigen Tier geltenden Bedingungen verwendet Google die über die API übermittelten Eingaben und Ausgaben nicht zum Training seiner Modelle; die Verarbeitung erfolgt im Rahmen des Google-Cloud-Datenverarbeitungszusatzes (Data Processing Addendum). Gleichwohl wird empfohlen, im Chat keine besonders sensiblen personenbezogenen Daten (z.&nbsp;B. Gesundheitsdaten, Bankdaten, Passwörter) einzugeben.</p>

                    <h4>Speicherdauer</h4>
                    <p>Die im Chat-Interface des Browsers angezeigten Gesprächsdaten werden ausschließlich für die Dauer der Sitzung gespeichert und beim Schließen des Browsers bzw. beim manuellen Zurücksetzen des Chats gelöscht. Über n8n weitergeleitete Daten werden nach Abschluss der Bearbeitung der jeweiligen Anfrage gelöscht. Die zu Auswertungszwecken in Google Sheets gespeicherten Fragen werden spätestens nach zwölf Monaten gelöscht. Für eine etwaige Speicherung auf Seiten von Google (z.&nbsp;B. zur Missbrauchserkennung) gelten die Google-Datenschutzbestimmungen.</p>
                    <p>Weitere Informationen entnehmen Sie der Google-Datenschutzrichtlinie (<a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy?hl=de</a>) sowie den Nutzungsbedingungen der Gemini API (<a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer">https://ai.google.dev/gemini-api/terms</a>).</p>
