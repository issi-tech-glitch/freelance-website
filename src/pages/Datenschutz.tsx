        ...
        <section id="datenschutz" className="section-padding">
            <div className="container-section">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h3>KI-Chatbot „Pia" (Google Gemini / Google AI Studio)</h3>
                    <p>Auf dieser Website ist der KI-gestützte Chatbot „Pia" integriert, der auf dem Sprachmodell Google Gemini 2.5 Flash basiert und über die Google AI Studio API betrieben wird. Pia ist als KI-System gemäß Art. 50 EU AI Act ausdrücklich als solches gekennzeichnet.</p>

                    <h4>Verarbeitete Daten</h4>
                    <p>Bei jeder Nachricht, die im Chatbot eingegeben wird, werden die Texteingaben sowie der gesamte bisherige Gesprächsverlauf der Sitzung an die Google AI Studio API übermittelt. Dies kann personenbezogene Daten umfassen, die freiwillig eingegeben werden – darunter insbesondere E-Mail-Adressen, Namen oder Projektbeschreibungen. Eingegebene E-Mail-Adressen werden damit an Google übertragen und dort verarbeitet.</p>
                    ...
                    <p>Der Chatbot verfügt über automatisierte Werkzeuge (sog. „Tools"), über die im Gespräch erfasste Daten gespeichert und weitergeleitet werden können. Hierfür wird die selbst gehostete Workflow-Automatisierungsplattform n8n eingesetzt, die auf Servern der Netcup GmbH (Daimlerstraße 25, 76185 Karlsruhe, Deutschland) betrieben wird. Eine Übermittlung dieser Daten in Drittländer findet im Rahmen von n8n nicht statt.</p>
                    ...
                    <h4>Google AI Studio – Dienstleister und Drittlandübermittlung</h4>
                    ...
                    <p>Gemäß den Nutzungsbedingungen von Google AI Studio können über die API eingereichte Eingaben und Ausgaben durch Google zur Qualitätssicherung und Weiterentwicklung des Dienstes verwendet werden. Es wird daher ausdrücklich empfohlen, im Chat keine besonders sensiblen personenbezogenen Daten (z.&nbsp;B. Gesundheitsdaten, Bankdaten, Passwörter) einzugeben.</p>

                    <h4>Speicherdauer</h4>
                    <p>Die im Chat-Interface des Browsers angezeigten Gesprächsdaten werden ausschließlich für die Dauer der Sitzung gespeichert und beim Schließen des Browsers bzw. beim manuellen Zurücksetzen des Chats gelöscht. Über n8n weitergeleitete Daten werden nach Abschluss der Bearbeitung der jeweiligen Anfrage gelöscht. Für eine etwaige Speicherung auf Seiten von Google gelten die Google-Datenschutzbestimmungen.</p>
                    <p>Weitere Informationen entnehmen Sie der Google-Datenschutzrichtlinie (<a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy?hl=de</a>) sowie den Google AI Studio-Nutzungsbedingungen (<a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer">https://ai.google.dev/gemini-api/terms</a>).</p>
